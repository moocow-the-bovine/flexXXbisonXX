...
;;;; File: bison++-mode.el
;;;; Description:
;;;;   + Major mode for parser specifications a la
;;;;     Alain Coetmeur's "bison++" sources.
;;;;
;;;; based on 'bison-mode.el':
...
(defvar bison++-font-lock-keywords c-bison++-keywords
  "Default expressions to highlight in Bison++ mode")
...
(define-derived-mode bison++-mode flex++-mode "Bison++"
  ...
  (setq bison++-mode-map (make-keymap "bison++-mode-map"))
